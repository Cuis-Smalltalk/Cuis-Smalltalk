...
$ mkdir MyProject
$ cd MyProject
$ wget https://github.com/Cuis-Smalltalk/Cuis-Smalltalk/archive/master.zip
$ unzip master.zip
...
```
```
$ coglinuxht/squeak Cuis-Smalltalk-master/Cuis4.2-2763.image
```
...
$ mkdir MyProject
$ cd MyProject
$ curl -L -o master.zip  https://github.com/Cuis-Smalltalk/Cuis-Smalltalk/archive/master.zip
$ unzip master.zip
$ curl -o Cog.app.tgz http://www.mirandabanda.org/files/Cog/VM/latest/Cog.app-16.18.3692.tgz
$ tar -zxvf Cog.app.tgz
$ Cog.app/Contents/MacOS/Squeak Cuis-Smalltalk-master/Cuis4.2-2763.image
```